...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-navy">
      ...
      />
      <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-8 px-4 pt-30 md:pt-12 py-12 md:flex-row md:justify-between md:py-16">
        <div className="max-w-md text-center md:text-left">
          <h1 className="text-3xl font-normal text-primary-foreground md:text-5xl text-balance">
          ...
          <button
            type="button"
            className="mt-6 hidden md:block rounded-md border text-md border-primary-foreground/50 px-4 py-1.5 text-primary-foreground transition-colors hover:bg-primary-foreground/10"
          >
            Buy now
          </button>
        </div>
        ...
        <button
          type="button"
          className="mt-6 md:hidden rounded-md border text-md border-primary-foreground/50 px-4 py-1.5 text-primary-foreground transition-colors hover:bg-primary-foreground/10"
        >
          Buy now
        </button>
      </div>
